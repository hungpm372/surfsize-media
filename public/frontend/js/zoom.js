/*
    ...
    filter: grayscale(80%) opacity(60%); img
*/
(function ($) {
    "use strict";
    $.fn.extend({
        extm: function extm(userOptions) {
            ...
            function extmInit(options, imageElement) {
                ...
                if (!options.zoomElement) {
                    zoomElement = $("<div style='box-shadow: 0 0 3px rgba(0, 0, 0, .4);overflow:hidden;pointer-events:none;height:" + smallHeight + "px;width:" + smallWidth + "px;' class='extm'></div>");
                ...
                innerOverlayElement = $("<div style='background-color:rgba(0,0,0,0.5);position:absolute;' class='innerOverlay'></div>");
