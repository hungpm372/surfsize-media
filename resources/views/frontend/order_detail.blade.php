...
@section('css')
    <style>
        ...
        .order-container .wrap-iten-in-cart {
            padding: 0;
            margin-bottom: 0;
        }

        .order-container .order-detail td:first-child {
            max-width: 120px;
            width: 120px;
        }
    </style>
                    ...
                    <div class="wrap-iten-in-cart">
                        ...
                        @if ($order->order_status_id != 4 && $order->order_status_id != 3)
                            <div class="order-wrap">
                                <a id="cancel-order" class="btn btn-xs" href="#" data-url="{{ route('cancel_order') }}" data-order-code="{{ $order->order_code }}">Hủy đơn
                                    hàng</a>
