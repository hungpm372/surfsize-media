                                ...
                                <div class="wrap-list-item apps-list">
                                    <ul>
                                        <li><a href="#" class="link-to-item" title="our application on apple store">
                                                <figure><img src="{{ asset('frontend/images/brands/apple-store.png') }}" alt="apple store" width="128"
                                                        height="36">
                                                </figure>
                                            </a></li>
                                        <li><a href="#" class="link-to-item" title="our application on google play store">
                                                <figure><img src="{{ asset('frontend/images/brands/google-play-store.png') }}" alt="google play store"
                                                        width="128" height="36">
                                                </figure>
                                            </a></li>
                                    </ul>
                        ...
                        <div class="wrap-footer-item">
                            ...
                            <div class="item-content">
                                <div class="wrap-list-item wrap-verification">
                                    <ul>
                                        <li>
                                            <a href="//www.dmca.com/Protection/Status.aspx?ID=41b508e4-c4df-4629-b515-ccdfb0b11e69"
        ...
        <div class="coppy-right-box">
            <div class="container">
                <div class="coppy-right-item item-left">
                    <p class="coppy-right-text">Copyright © {{ date('Y') }} Phan Minh Hung. All rights
                        reserved</p>
                </div>
